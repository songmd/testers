# Generated by Django 2.0.2 on 2018-02-20 12:28
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_num', models.CharField(blank=True, max_length=16, null=True, verbose_name='联系电话')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(default='appcst', editable=False, max_length=16, verbose_name='用户类型')),
                ('phone_num', models.CharField(blank=True, max_length=16, null=True, verbose_name='手机号')),
                ('nick_name', models.CharField(blank=True, max_length=32, null=True, verbose_name='昵称')),
                ('openid', models.CharField(blank=True, editable=False, max_length=128, null=True, verbose_name='微信OpenId')),
                ('session_key', models.CharField(blank=True, editable=False, max_length=128, null=True, verbose_name='会话密钥')),
                ('unionid', models.CharField(blank=True, editable=False, max_length=128, null=True, verbose_name='统一Id')),
            ],
            options={
                'verbose_name': '客户',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(default='appmch', editable=False, max_length=16, verbose_name='用户类型')),
                ...
                ('key_file', models.FileField(blank=True, null=True, upload_to='', verbose_name='密钥文件')),
                ('cert_file', models.FileField(blank=True, null=True, upload_to='', verbose_name='证书文件')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('Open', 'Open - currently active'), ('Saved', 'Frozen - the basket cannot be modified'), ('Submitted', 'Submitted - has been ordered at the checkout')], default='Open', max_length=12, verbose_name='状态')),
                ('date_created', models.DateTimeField(auto_now_add=True, verbose_name='生成时间')),
                ('date_submitted', models.DateTimeField(blank=True, null=True, verbose_name='提交时间')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='baskets', to='estore.AppCustomer', verbose_name='客户')),
            ],
            options={
                'verbose_name': '购物车',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(decimal_places=2, max_digits=12, null=True, verbose_name='成交价格')),
                ('date_created', models.DateTimeField(auto_now_add=True, verbose_name='生成时间')),
                ('basket', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='lines', to='estore.Basket', verbose_name='购物车')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('number', models.CharField(db_index=True, max_length=128, unique=True, verbose_name='订单号')),
                ('shipping_method', models.CharField(blank=True, max_length=128, verbose_name='送货方式')),
                ('shipping_code', models.CharField(blank=True, default='', max_length=128, verbose_name='快递单号')),
                ('status', models.CharField(blank=True, max_length=100, verbose_name='订单状态')),
                ('basket', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='estore.Basket', verbose_name='购物车')),
                ('consumer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='orders', to='estore.AppCustomer', verbose_name='客户')),
                ('shipping_address', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='estore.Address', verbose_name='送货地址')),
            ],
            options={
                'verbose_name': '订单',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.SlugField(max_length=32, verbose_name='属性编码')),
                ('type', models.CharField(choices=[('', '-------------'), ('text', '文字'), ('integer', '整数'), ('boolean', '是/否'), ('float', '浮点数'), ('richtext', '富文本'), ('date', '日期'), ('datetime', '时间'), ('option', '选项'), ('multi_option', '多选项'), ('entity', '实体'), ('file', '文件'), ('image', '图片')], default='', max_length=20, verbose_name='类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='所属商户')),
            ],
            options={
                'verbose_name': '店铺',
        ...
        migrations.AddField(
            model_name='product',
            name='owner',
            field=models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='products', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='product',
            name='pics',
        ...
        migrations.AddField(
            model_name='product',
            name='product_class',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='products', to='estore.ProductClass', verbose_name='种类'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='belong',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='customers', to='estore.ShopInfo', verbose_name='所属店铺'),
        ),
        migrations.AddField(
            model_name='address',
            name='owner',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='addresses', to='estore.AppCustomer', verbose_name='客户'),
        ),
